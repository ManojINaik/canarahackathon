...
- [Logout](https://gsap.com/community/logout/?csrfKey=db91e0d9a42273de9cc0d6c0954f8bea)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.killAll()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.killAll())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.killAll()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.killAll()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.killAll()/#)
...
[Previous\\
\\
.kill()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/kill()) [Next\\
\\
.labelToScroll()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/labelToScroll())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.killAll()/#details)
