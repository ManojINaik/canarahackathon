...
- [Logout](https://gsap.com/community/logout/?csrfKey=9033c397b286bf33946dcc25dc62a92f)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#)
...
### Returns : Boolean [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/\#returns--boolean "Direct link to Returns : Boolean")

If true, there is a ScrollTrigger-related scroller that's in the process of scrolling

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/\#details "Direct link to Details")
...
## Example [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/\#example "Direct link to Example")
...
[Previous\\
\\
ScrollTrigger.isInViewport()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isInViewport()) [Next\\
\\
.kill()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/kill())

## Contents

- [Returns : Boolean](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#returns--boolean)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isScrolling()/#example)
