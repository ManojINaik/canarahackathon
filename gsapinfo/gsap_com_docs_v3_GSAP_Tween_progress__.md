...
- [Logout](https://gsap.com/community/logout/?csrfKey=8a130f822ed43d55c996a590121b1b0b)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/progress()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/progress())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/progress()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/progress()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/progress()/#)
...
[Previous\\
\\
.play()](https://gsap.com/docs/v3/GSAP/Tween/play()) [Next\\
\\
.repeat()](https://gsap.com/docs/v3/GSAP/Tween/repeat())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/progress()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/progress()/#details)
