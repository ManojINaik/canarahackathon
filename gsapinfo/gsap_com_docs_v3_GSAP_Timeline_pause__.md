...
- [Logout](https://gsap.com/community/logout/?csrfKey=3e7e991ae1c7f79e1c0df97a5b4aedcf)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/pause()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/pause())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/pause()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/pause()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/pause()/#)
...
### Returns : self [​](https://gsap.com/docs/v3/GSAP/Timeline/pause()/\#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/pause()/\#details "Direct link to Details")
...
[Previous\\
\\
.nextLabel()](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()) [Next\\
\\
.paused()](https://gsap.com/docs/v3/GSAP/Timeline/paused())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/pause()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/pause()/#details)
