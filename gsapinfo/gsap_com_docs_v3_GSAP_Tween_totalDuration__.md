...
- [Logout](https://gsap.com/community/logout/?csrfKey=8a19e228ecbc2ec9a5664654a7ed7cb4)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/totalDuration())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/\#details "Direct link to Details")
...
[Previous\\
\\
.timeScale()](https://gsap.com/docs/v3/GSAP/Tween/timeScale()) [Next\\
\\
.totalProgress()](https://gsap.com/docs/v3/GSAP/Tween/totalProgress())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()/#details)
