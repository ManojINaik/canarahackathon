...
- [Logout](https://gsap.com/community/logout/?csrfKey=5f840f8eb53c2f34adf7107ffcbe1024)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.updateRoot()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.updateRoot())
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.updateRoot()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.updateRoot()/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.updateRoot()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.updateRoot()/#)
...
[Previous\\
\\
gsap.to()](https://gsap.com/docs/v3/GSAP/gsap.to()) [Next\\
\\
