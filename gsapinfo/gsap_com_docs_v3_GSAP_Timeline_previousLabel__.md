...
- [Logout](https://gsap.com/community/logout/?csrfKey=9db4fc3fbfd5459bec99996a40b061ca)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/#)
...
### Returns : String [​](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/\#returns--string "Direct link to Returns : String")
...
### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/\#details "Direct link to Details")
...
[Previous\\
\\
.play()](https://gsap.com/docs/v3/GSAP/Timeline/play()) [Next\\
\\
.progress()](https://gsap.com/docs/v3/GSAP/Timeline/progress())

## Contents

- [Returns : String](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/#returns--string)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()/#details)
