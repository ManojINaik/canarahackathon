...
- [Logout](https://gsap.com/community/logout/?csrfKey=d50ed2513909680e7d41013df092feae)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/startTime())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/\#details "Direct link to Details")
...
[Previous\\
\\
.shiftChildren()](https://gsap.com/docs/v3/GSAP/Timeline/shiftChildren()) [Next\\
\\
.then()](https://gsap.com/docs/v3/GSAP/Timeline/then())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/startTime()/#details)
