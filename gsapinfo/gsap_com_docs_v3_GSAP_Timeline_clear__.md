...
- [Logout](https://gsap.com/community/logout/?csrfKey=e93e3b934847ba97f84d8a5e9aa06d69)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/clear()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/clear())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/clear()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/clear()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/clear()/#)
...
[Previous\\
\\
.call()](https://gsap.com/docs/v3/GSAP/Timeline/call()) [Next\\
\\
.currentLabel()](https://gsap.com/docs/v3/GSAP/Timeline/currentLabel())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/clear()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/clear()/#details)
