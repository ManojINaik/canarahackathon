...
- [Logout](https://gsap.com/community/logout/?csrfKey=c8e9715a94c6ba38b5e590c7f9fde052)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill())
...
- [ScrollSmoother](https://gsap.com/docs/v3/Plugins/ScrollSmoother/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill()/\#details "Direct link to Details")

Kills the entire ScrollSmoother as well as any effects that were applied.

[Previous\\
\\
.getVelocity()](https://gsap.com/docs/v3/Plugins/ScrollSmoother/getVelocity()) [Next\\
\\
.offset()](https://gsap.com/docs/v3/Plugins/ScrollSmoother/offset())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollSmoother/kill()/#details)
