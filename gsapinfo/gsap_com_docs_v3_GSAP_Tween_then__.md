...
- [Logout](https://gsap.com/community/logout/?csrfKey=af51ac42e04d70f05a6036be8466c0e5)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/then()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/then())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/then()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/then()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/then()/#)
...
[Previous\\
\\
.targets()](https://gsap.com/docs/v3/GSAP/Tween/targets()) [Next\\
\\
.time()](https://gsap.com/docs/v3/GSAP/Tween/time())

## Contents

- [Returns : Promise](https://gsap.com/docs/v3/GSAP/Tween/then()/#returns--promise)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/then()/#details)
