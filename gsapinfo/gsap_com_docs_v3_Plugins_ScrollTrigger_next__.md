...
- [Logout](https://gsap.com/community/logout/?csrfKey=a527bd2d41f0dabc49e4525849f6c0c3)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/#)
...
### Returns : ScrollTrigger instance [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/\#returns--scrolltrigger-instance "Direct link to Returns : ScrollTrigger instance")

The next ScrollTrigger in the refresh order

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/\#details "Direct link to Details")

Returns the next ScrollTrigger in the refresh order.

[Previous\\
\\
ScrollTrigger.maxScroll()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()) [Next\\
\\
ScrollTrigger.normalizeScroll()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.normalizeScroll())

## Contents

- [Returns : ScrollTrigger instance](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/#returns--scrolltrigger-instance)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next()/#details)
