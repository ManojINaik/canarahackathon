...
- [Logout](https://gsap.com/community/logout/?csrfKey=13b96d04558d9832ff45ab0aa55e1dc0)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/play()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/play())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/play()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/play()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/play()/#)
...
### Returns : self [​](https://gsap.com/docs/v3/GSAP/Tween/play()/\#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/play()/\#details "Direct link to Details")
...
[Previous\\
\\
.paused()](https://gsap.com/docs/v3/GSAP/Tween/paused()) [Next\\
\\
.progress()](https://gsap.com/docs/v3/GSAP/Tween/progress())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Tween/play()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/play()/#details)
