...
- [Logout](https://gsap.com/community/logout/?csrfKey=b7d6bd0e5f8419104ef62f808b684774)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation)
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#)
    ...
    - [.scroll()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#)
...
### Returns : Tween \| Timeline \| undefined [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/\#returns--tween--timeline--undefined "Direct link to Returns : Tween | Timeline | undefined")

The Tween or Timeline associated with the ScrollTrigger (if any)

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/\#details "Direct link to Details")
...
## Embedded example [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/\#embedded-example "Direct link to Embedded example")
...
## Standalone example [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/\#standalone-example "Direct link to Standalone example")
...
[Previous\\
\\
ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/) [Next\\
\\
.direction](https://gsap.com/docs/v3/Plugins/ScrollTrigger/direction)

## Contents

- [Returns : Tween \| Timeline \| undefined](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#returns--tween--timeline--undefined)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#details)
- [Embedded example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#embedded-example)
- [Standalone example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/animation/#standalone-example)
