...
- [Logout](https://gsap.com/community/logout/?csrfKey=11efaefb4c8eb9dd313932eeea8bbd72)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/#)
  ...
  - [MorphSVG](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/#)
...
### Returns : RawPath [​](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/\#returns--rawpath "Direct link to Returns : RawPath")
...
### Details [​](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/\#details "Direct link to Details")
...
[Previous\\
\\
MorphSVGPlugin.rawPathToString()](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.rawPathToString) [Next\\
\\
MotionPath](https://gsap.com/docs/v3/Plugins/MotionPathPlugin)

## Contents

- [Returns : RawPath](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/#returns--rawpath)
- [Details](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin/static.stringToRawPath/#details)
