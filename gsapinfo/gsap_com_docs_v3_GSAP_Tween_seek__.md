...
- [Logout](https://gsap.com/community/logout/?csrfKey=9039e4cd88396429f53cb3f26bb70556)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/seek()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/seek())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/seek()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/seek()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/seek()/#)
...
### Returns : self [​](https://gsap.com/docs/v3/GSAP/Tween/seek()/\#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/seek()/\#details "Direct link to Details")
...
[Previous\\
\\
.revert()](https://gsap.com/docs/v3/GSAP/Tween/revert()) [Next\\
\\
.startTime()](https://gsap.com/docs/v3/GSAP/Tween/startTime())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Tween/seek()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/seek()/#details)
