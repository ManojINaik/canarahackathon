...
- [Logout](https://gsap.com/community/logout/?csrfKey=7f7b0d823dca135cfca039c64ddfd5f2)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/restart()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/restart())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/restart()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/restart()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/restart()/#)
...
[Previous\\
\\
.repeatDelay()](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()) [Next\\
\\
.resume()](https://gsap.com/docs/v3/GSAP/Timeline/resume())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/restart()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/restart()/#details)
