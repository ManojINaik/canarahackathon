...
- [Logout](https://gsap.com/community/logout/?csrfKey=3095be4d46fb428fea48bdcb2996d1f6)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/static.getById())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/#)

      - [.disable()](https://gsap.com/docs/v3/Plugins/Observer/disable())
...
### Returns : Observer [​](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/\#returns--observer "Direct link to Returns : Observer")

The Observer associated with the `id` (or null if none is found)

### Details [​](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/\#details "Direct link to Details")
...
[Previous\\
\\
Observer.getAll()](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()) [Next\\
\\
Physics2D](https://gsap.com/docs/v3/Plugins/Physics2DPlugin)

## Contents

- [Returns : Observer](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/#returns--observer)
- [Details](https://gsap.com/docs/v3/Plugins/Observer/static.getById()/#details)
