...
- [Logout](https://gsap.com/community/logout/?csrfKey=0c733b40b67fdac0f5fe6b96d4869924)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller)
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/#)
...
### Returns : Element \| window [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/\#returns--element--window "Direct link to Returns : Element | window")

The element (or window) associated with the ScrollTrigger instance

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/\#details "Direct link to Details")

\[read-only\] The scroller element (or window) associated with the ScrollTrigger. It's the thing whose scrollbar is linked to the ScrollTrigger. By default, it's the window (viewport).

[Previous\\
\\
.progress](https://gsap.com/docs/v3/Plugins/ScrollTrigger/progress) [Next\\
\\
.start](https://gsap.com/docs/v3/Plugins/ScrollTrigger/start)

## Contents

- [Returns : Element \| window](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/#returns--element--window)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroller/#details)
