...
- [Logout](https://gsap.com/community/logout/?csrfKey=1d1b4777fb4b3cd5a95c86882d178f3a)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/UtilityMethods/getUnit()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/UtilityMethods/getUnit())
...
- [more plugins](https://gsap.com/docs/v3/GSAP/UtilityMethods/getUnit()/#)
...
[Previous\\
\\
distribute](https://gsap.com/docs/v3/GSAP/UtilityMethods/distribute()) [Next\\
\\
interpolate](https://gsap.com/docs/v3/GSAP/UtilityMethods/interpolate())

## Contents

- [Returns : String](https://gsap.com/docs/v3/GSAP/UtilityMethods/getUnit()/#returns--string)
- [Parameters](https://gsap.com/docs/v3/GSAP/UtilityMethods/getUnit()/#parameters)
