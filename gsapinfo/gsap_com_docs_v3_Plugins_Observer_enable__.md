...
- [Logout](https://gsap.com/community/logout/?csrfKey=cd77fb8f25abac0b2254d4a363b67a45)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/enable()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/enable())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/enable()/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/enable()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/enable()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/enable()/\#details "Direct link to Details")

Enables the Observer, adding the necessary event listeners and firing the `onEnable` callback if the Observer wasn't already enabled.

[Previous\\
\\
.disable()](https://gsap.com/docs/v3/Plugins/Observer/disable()) [Next\\
\\
.kill()](https://gsap.com/docs/v3/Plugins/Observer/kill())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/enable()/#details)
