...
- [Logout](https://gsap.com/community/logout/?csrfKey=fb22f38502fb55be66651de7a336b135)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/pointerY/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/pointerY)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/pointerY/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/pointerY/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/pointerY/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/pointerY/\#details "Direct link to Details")
...
[Previous\\
\\
.pointerX](https://gsap.com/docs/v3/Plugins/Draggable/pointerX) [Next\\
\\
.rotation](https://gsap.com/docs/v3/Plugins/Draggable/rotation)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/pointerY/#details)
