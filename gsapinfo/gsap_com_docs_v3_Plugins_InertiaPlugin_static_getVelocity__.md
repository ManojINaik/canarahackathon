...
- [Logout](https://gsap.com/community/logout/?csrfKey=4902cfd8de162397d77194ec7660b704)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/\#details "Direct link to Details")

Returns the current velocity of the given property and target object (only works if you started tracking the property using the [`InertiaPlugin.track()`](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.track()) method).

### Example [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/\#example "Direct link to Example")
...
[Previous\\
\\
Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/) [Next\\
\\
InertiaPlugin.isTracking()](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.isTracking())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.getVelocity()/#example)
