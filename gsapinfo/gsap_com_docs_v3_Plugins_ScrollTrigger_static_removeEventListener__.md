...
- [Logout](https://gsap.com/community/logout/?csrfKey=4831277e90e5dce92d166f27dd2308f5)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()/#)
...
[Previous\\
\\
.refresh()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/refresh()) [Next\\
\\
ScrollTrigger.saveStyles()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()/#example)
