...
- [Logout](https://gsap.com/community/logout/?csrfKey=4f37bf9636ff5511d08feb806e727d5b)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/\#details "Direct link to Details")
...
[Previous\\
\\
.to()](https://gsap.com/docs/v3/GSAP/Timeline/to()) [Next\\
\\
.totalProgress()](https://gsap.com/docs/v3/GSAP/Timeline/totalProgress())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/totalDuration()/#details)
