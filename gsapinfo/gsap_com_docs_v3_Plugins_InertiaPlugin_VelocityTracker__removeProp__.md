...
- [Logout](https://gsap.com/community/logout/?csrfKey=6617ca4a6ae50d0c5378226962cca4f9)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp()/#)
...
## Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp()/\#details "Direct link to Details")

Stops tracking a particular property.

[Previous\\
\\
.isTrackingProp](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()) [Next\\
\\
.track](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.track)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp()/#details)
