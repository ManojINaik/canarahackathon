...
- [Logout](https://gsap.com/community/logout/?csrfKey=c43a4c71ff59ca96a8cf9ee62b3cd7bc)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/enabled())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/#)
...
### Returns : Boolean [​](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/\#returns--boolean "Direct link to Returns : Boolean")

Returns `true` if the Draggable instance is able to be dragged ( `false` if not).

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/\#details "Direct link to Details")
...
[Previous\\
\\
.enable()](https://gsap.com/docs/v3/Plugins/Draggable/enable()) [Next\\
\\
.endDrag()](https://gsap.com/docs/v3/Plugins/Draggable/endDrag())

## Contents

- [Returns : Boolean](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/#returns--boolean)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/enabled()/#details)
