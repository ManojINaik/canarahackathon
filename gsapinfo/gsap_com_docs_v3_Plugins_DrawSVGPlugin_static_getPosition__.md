...
- [Logout](https://gsap.com/community/logout/?csrfKey=dc0864e8b72721a69b990a4d0a793bd0)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/#)
  ...
  - [DrawSVG](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/#)
...
### Returns : Number [​](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/\#returns--number "Direct link to Returns : Number")

The position of an SVG element's stroke.

### Details [​](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/\#details "Direct link to Details")
...
[Previous\\
\\
DrawSVGPlugin.getLength()](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getLength()) [Next\\
\\
Easel](https://gsap.com/docs/v3/Plugins/EaselPlugin)

## Contents

- [Returns : Number](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/#returns--number)
- [Details](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin/static.getPosition()/#details)
