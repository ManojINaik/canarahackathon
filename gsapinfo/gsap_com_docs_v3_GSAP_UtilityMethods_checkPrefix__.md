...
- [Logout](https://gsap.com/community/logout/?csrfKey=12174d89f1347338f9bfbf1b6ea3842a)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/UtilityMethods/checkPrefix()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/UtilityMethods/checkPrefix())
...
- [more plugins](https://gsap.com/docs/v3/GSAP/UtilityMethods/checkPrefix()/#)
...
[Previous\\
\\
Utility Methods](https://gsap.com/docs/v3/GSAP/UtilityMethods) [Next\\
\\
clamp](https://gsap.com/docs/v3/GSAP/UtilityMethods/clamp())

## Contents

- [Returns : String](https://gsap.com/docs/v3/GSAP/UtilityMethods/checkPrefix()/#returns--string)
- [Parameters](https://gsap.com/docs/v3/GSAP/UtilityMethods/checkPrefix()/#parameters)
