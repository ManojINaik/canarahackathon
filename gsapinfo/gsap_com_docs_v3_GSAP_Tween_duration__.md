...
- [Logout](https://gsap.com/community/logout/?csrfKey=75eb209d0b3acd16438274776579d770)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/duration()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/duration())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/duration()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/duration()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/duration()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Tween/duration()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/duration()/\#details "Direct link to Details")
...
[Previous\\
\\
.delay()](https://gsap.com/docs/v3/GSAP/Tween/delay()) [Next\\
\\
.endTime()](https://gsap.com/docs/v3/GSAP/Tween/endTime())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/duration()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/duration()/#details)
