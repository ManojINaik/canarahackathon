...
- [Logout](https://gsap.com/community/logout/?csrfKey=7d6b32bbcf2b27c9bd75964acb2b1a74)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/targets()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/targets())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/targets()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/targets()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/targets()/#)
...
### Details [​](https://gsap.com/docs/v3/GSAP/Tween/targets()/\#details "Direct link to Details")
...
[Previous\\
\\
.startTime()](https://gsap.com/docs/v3/GSAP/Tween/startTime()) [Next\\
\\
.then()](https://gsap.com/docs/v3/GSAP/Tween/then())

## Contents

- [Details](https://gsap.com/docs/v3/GSAP/Tween/targets()/#details)
