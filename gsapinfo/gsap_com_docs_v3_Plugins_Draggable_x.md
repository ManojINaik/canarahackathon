...
- [Logout](https://gsap.com/community/logout/?csrfKey=8035da9d105565fdab1b3b39d2556000)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/x/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/x)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/x/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/x/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/x/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/x/\#details "Direct link to Details")
...
[Previous\\
\\
.vars](https://gsap.com/docs/v3/Plugins/Draggable/vars) [Next\\
\\
.y](https://gsap.com/docs/v3/Plugins/Draggable/y)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/x/#details)
