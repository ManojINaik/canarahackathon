...
- [Logout](https://gsap.com/community/logout/?csrfKey=6fd6019fb3e72d136cd82acd68748620)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()/#)
...
## Description [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()/\#description "Direct link to Description")

Adds a property to track.

[Previous\\
\\
.target](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.target) [Next\\
\\
.get](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get())

## Contents

- [Description](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()/#description)
