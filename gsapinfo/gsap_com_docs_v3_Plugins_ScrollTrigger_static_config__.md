...
- [Logout](https://gsap.com/community/logout/?csrfKey=57092b86f12d6f55a73453463d79df8b)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()/#)
...
[Previous\\
\\
ScrollTrigger.clearScrollMemory()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.clearScrollMemory()) [Next\\
\\
ScrollTrigger.create()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()/#example)
