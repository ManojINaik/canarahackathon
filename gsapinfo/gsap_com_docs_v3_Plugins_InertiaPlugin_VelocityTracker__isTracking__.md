...
- [Logout](https://gsap.com/community/logout/?csrfKey=6780d83bb12fa844e63e90e5c7c8ff15)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/#)
...
### Returns : Boolean [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/\#returns--boolean "Direct link to Returns : Boolean")

Returns `true` if the target is being tracked, `false` if not.

* * *

## Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/\#details "Direct link to Details")

Allows you to discern whether the velocity of a particular target is being tracked (typically initiated using the `VelocityTracker.track()` method).

[Previous\\
\\
.getByTarget](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()) [Next\\
\\
.isTrackingProp](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp())

## Contents

- [Returns : Boolean](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/#returns--boolean)
- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()/#details)
