...
- [Logout](https://gsap.com/community/logout/?csrfKey=9a9daa029759caebd68bca0dbe546228)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/#)
...
### Returns : Number [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/\#returns--number "Direct link to Returns : Number")

The current velocity.

* * *

## Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/\#details "Direct link to Details")

Returns the current velocity of the given property.

[Previous\\
\\
.addProp](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.addProp()) [Next\\
\\
.getByTarget](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget())

## Contents

- [Returns : Number](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/#returns--number)
- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()/#details)
