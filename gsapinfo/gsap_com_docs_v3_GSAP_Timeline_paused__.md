...
- [Logout](https://gsap.com/community/logout/?csrfKey=19d47529fda5e9ef0ade0f7ec0a479ae)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/paused()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/paused())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/paused()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/paused()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/paused()/#)
...
[Previous\\
\\
.pause()](https://gsap.com/docs/v3/GSAP/Timeline/pause()) [Next\\
\\
.play()](https://gsap.com/docs/v3/GSAP/Timeline/play())

## Contents

- [Returns : \[Boolean \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/paused()/#returns--boolean--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/paused()/#details)
