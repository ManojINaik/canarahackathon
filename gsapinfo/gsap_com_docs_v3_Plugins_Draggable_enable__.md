...
- [Logout](https://gsap.com/community/logout/?csrfKey=a1cd53b08cd3cd4f1090c1234ac7f30c)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/enable()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/enable())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/enable()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/enable()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/enable()/#)
...
### Returns : Draggable [​](https://gsap.com/docs/v3/Plugins/Draggable/enable()/\#returns--draggable "Direct link to Returns : Draggable")

The Draggable instance itself (to make chaining possible).

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/enable()/\#details "Direct link to Details")

Enables the Draggable instance so that it can be dragged.

[Previous\\
\\
.disable()](https://gsap.com/docs/v3/Plugins/Draggable/disable()) [Next\\
\\
.enabled()](https://gsap.com/docs/v3/Plugins/Draggable/enabled())

## Contents

- [Returns : Draggable](https://gsap.com/docs/v3/Plugins/Draggable/enable()/#returns--draggable)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/enable()/#details)
