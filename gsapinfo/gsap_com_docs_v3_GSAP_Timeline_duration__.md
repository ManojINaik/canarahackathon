...
- [Logout](https://gsap.com/community/logout/?csrfKey=644e28096ca85c6f063c83be4b6f362b)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/duration()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/duration())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/duration()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/duration()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/duration()/#)
...
[Previous\\
\\
.delay()](https://gsap.com/docs/v3/GSAP/Timeline/delay()) [Next\\
\\
.endTime()](https://gsap.com/docs/v3/GSAP/Timeline/endTime())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/duration()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/duration()/#details)
