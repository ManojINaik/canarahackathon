...
- [Logout](https://gsap.com/community/logout/?csrfKey=1d7987e911b2057943a2a7c7cae6ab3b)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/#)
...
### Returns : String [​](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/\#returns--string "Direct link to Returns : String")
...
### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/\#details "Direct link to Details")
...
[Previous\\
\\
.killTweensOf()](https://gsap.com/docs/v3/GSAP/Timeline/killTweensOf()) [Next\\
\\
.pause()](https://gsap.com/docs/v3/GSAP/Timeline/pause())

## Contents

- [Returns : String](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/#returns--string)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/nextLabel()/#details)
