...
- [Logout](https://gsap.com/community/logout/?csrfKey=037f65126853e1b72f40bc7e62186bef)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/#)
  ...
  - [ScrollTo](https://gsap.com/docs/v3/Plugins/ScrollToPlugin)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/\#details "Direct link to Details")
...
### Example [​](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/\#example "Direct link to Example")
...
[Previous\\
\\
ScrollTo](https://gsap.com/docs/v3/Plugins/ScrollToPlugin) [Next\\
\\
SplitText](https://gsap.com/docs/v3/Plugins/SplitText/)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollToPlugin/config()/#example)
