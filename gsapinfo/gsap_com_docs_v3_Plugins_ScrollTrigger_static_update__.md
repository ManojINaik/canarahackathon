...
- [Logout](https://gsap.com/community/logout/?csrfKey=c7ed39eca549b9f90f70b68a0c54fe94)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/#)
...
## When should I use ScrollTrigger.update()? [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/\#when-should-i-use-scrolltriggerupdate "Direct link to When should I use ScrollTrigger.update()?")
...
[Previous\\
\\
ScrollTrigger.refresh()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.refresh()) [Next\\
\\
ScrollSmoother](https://gsap.com/docs/v3/Plugins/ScrollSmoother/)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/#details)
- [When should I use ScrollTrigger.update()?](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.update()/#when-should-i-use-scrolltriggerupdate)
