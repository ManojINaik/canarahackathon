...
- [Logout](https://gsap.com/community/logout/?csrfKey=c330b0400d69fac02d1193c877cb4f49)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.set()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.set())
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.set()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.set()/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.set()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.set()/#)
...
### Returns : [Tween](https://gsap.com/docs/v3/GSAP/Tween) [​](https://gsap.com/docs/v3/GSAP/gsap.set()/\#returns--tween "Direct link to returns--tween")
...
[Previous\\
\\
gsap.registerPlugin()](https://gsap.com/docs/v3/GSAP/gsap.registerPlugin()) [Next\\
\\
gsap.timeline()](https://gsap.com/docs/v3/GSAP/gsap.timeline())

## Contents

- [Returns : Tween](https://gsap.com/docs/v3/GSAP/gsap.set()/#returns--tween)
