...
- [Logout](https://gsap.com/community/logout/?csrfKey=d75fd3d664af86e134a72fd384c38bde)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/vars/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/vars)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/vars/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/vars/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/vars/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/vars/\#details "Direct link to Details")

The configuration object that was originally passed in to the Observer.create().

[Previous\\
\\
.target](https://gsap.com/docs/v3/Plugins/Observer/target) [Next\\
\\
.velocityX](https://gsap.com/docs/v3/Plugins/Observer/velocityX)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/vars/#details)
