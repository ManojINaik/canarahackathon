...
- [Logout](https://gsap.com/community/logout/?csrfKey=63f711bcef0c3ded4dfa6da513ad7bdf)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/y/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/y)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/y/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/y/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/y/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/y/\#details "Direct link to Details")

the `clientY` from the most recent touch/pointer event, which refers to the vertical distance from the top edge of the viewport. This only gets updated if you set the `type` to include "touch" and/or "pointer".

[Previous\\
\\
.x](https://gsap.com/docs/v3/Plugins/Observer/x) [Next\\
\\
.disable()](https://gsap.com/docs/v3/Plugins/Observer/disable())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/y/#details)
