...
- [Logout](https://gsap.com/community/logout/?csrfKey=70b8ad1743db58a4e8a6130dd4281896)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#)
...
### Returns : Number \| null [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/\#returns--number--null "Direct link to Returns : Number | null")
...
### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/\#details "Direct link to Details")
...
## Example [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/\#example "Direct link to Example")
...
[Previous\\
\\
ScrollTrigger.saveStyles()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()) [Next\\
\\
ScrollTrigger.scrollerProxy()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.scrollerProxy())

## Contents

- [Returns : Number \| null](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#returns--number--null)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll()/#example)
