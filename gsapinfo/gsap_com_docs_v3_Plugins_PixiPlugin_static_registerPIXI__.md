...
- [Logout](https://gsap.com/community/logout/?csrfKey=d508ed1dc128be8a213e65ec225f0dc5)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/PixiPlugin/static.registerPIXI()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/PixiPlugin/static.registerPIXI())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/PixiPlugin/static.registerPIXI()/#)
  ...
  - [Pixi](https://gsap.com/docs/v3/Plugins/PixiPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/PixiPlugin/static.registerPIXI()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/PixiPlugin/static.registerPIXI()/\#details "Direct link to Details")
...
[Previous\\
\\
Pixi](https://gsap.com/docs/v3/Plugins/PixiPlugin/) [Next\\
\\
ScrambleText](https://gsap.com/docs/v3/Plugins/ScrambleTextPlugin)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/PixiPlugin/static.registerPIXI()/#details)
