...
- [Logout](https://gsap.com/community/logout/?csrfKey=2bc30a891eedbbbf832488e310b84474)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/UtilityMethods/toArray()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/UtilityMethods/toArray())
...
- [more plugins](https://gsap.com/docs/v3/GSAP/UtilityMethods/toArray()/#)
...
[Previous\\
\\
splitColor](https://gsap.com/docs/v3/GSAP/UtilityMethods/splitColor()) [Next\\
\\
unitize](https://gsap.com/docs/v3/GSAP/UtilityMethods/unitize())

## Contents

- [Returns : Array](https://gsap.com/docs/v3/GSAP/UtilityMethods/toArray()/#returns--array)
- [Parameters](https://gsap.com/docs/v3/GSAP/UtilityMethods/toArray()/#parameters)
