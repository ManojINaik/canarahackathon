...
- [Logout](https://gsap.com/community/logout/?csrfKey=20680941c61ae7ae643ab3c56c856529)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content())
...
- [ScrollSmoother](https://gsap.com/docs/v3/Plugins/ScrollSmoother/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#)
...
### Returns : Element \| self [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/\#returns--element--self "Direct link to Returns : Element | self")

The content Element (or the ScrollSmoother instance if used as a setter)

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/\#details "Direct link to Details")

Gets/Sets the content element.

### Getter [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/\#getter "Direct link to Getter")
...
### Setter [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/\#setter "Direct link to Setter")
...
[Previous\\
\\
.vars](https://gsap.com/docs/v3/Plugins/ScrollSmoother/vars) [Next\\
\\
.effects()](https://gsap.com/docs/v3/Plugins/ScrollSmoother/effects())

## Contents

- [Returns : Element \| self](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#returns--element--self)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#details)
- [Getter](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#getter)
- [Setter](https://gsap.com/docs/v3/Plugins/ScrollSmoother/content()/#setter)
