...
- [Logout](https://gsap.com/community/logout/?csrfKey=4db84fcb94f4c973a718b1f8de78f78a)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/static.get())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/#)
...
### Returns : Draggable [​](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/\#returns--draggable "Direct link to Returns : Draggable")

The Draggable instance that's associated with the target element (or `undefined` if none exists).

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/\#details "Direct link to Details")
...
[Previous\\
\\
.endDrag()](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()) [Next\\
\\
.getDirection()](https://gsap.com/docs/v3/Plugins/Draggable/getDirection())

## Contents

- [Returns : Draggable](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/#returns--draggable)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/static.get()/#details)
