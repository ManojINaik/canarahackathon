...
- [Logout](https://gsap.com/community/logout/?csrfKey=b3b13dc092b86f35ced9c8b4f43c2042)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/delay()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/delay())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/delay()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/delay()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/delay()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/delay()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/delay()/\#details "Direct link to Details")
...
[Previous\\
\\
.currentLabel()](https://gsap.com/docs/v3/GSAP/Timeline/currentLabel()) [Next\\
\\
.duration()](https://gsap.com/docs/v3/GSAP/Timeline/duration())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/delay()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/delay()/#details)
