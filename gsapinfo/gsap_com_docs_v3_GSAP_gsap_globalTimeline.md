...
- [Logout](https://gsap.com/community/logout/?csrfKey=e98d9352b5d85646e88a0971b96907d6)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline)
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#)
...
### Type : [Timeline](https://gsap.com/docs/v3/GSAP/Timeline) [​](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/\#type--timeline "Direct link to type--timeline")
...
## Useful Methods [​](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/\#useful-methods "Direct link to Useful Methods")

- `gsap.globalTimeline` [`.pause()`](https://gsap.com/docs/v3/GSAP/Timeline/pause()) \- Pauses the global timeline which affects **ALL** animations. Returns itself.

- `gsap.globalTimeline` [`.play()`](https://gsap.com/docs/v3/GSAP/Timeline/play()) \- Resumes the global timeline which affects **ALL** animations. Returns itself.

- `gsap.globalTimeline` [`.paused()`](https://gsap.com/docs/v3/GSAP/Timeline/paused()) \- Returns `true` if the global timeline is paused. Returns `false` if the global timeline is playing.

- `gsap.globalTimeline` [`.timeScale()`](https://gsap.com/docs/v3/GSAP/Timeline/timeScale()) \- Gets or sets the global time scale which is a multiplier that affects **ALL** animations. This doesn't actually set the `timeScale()` of each individual tween/timeline, but rather it affects the rate at which the root timeline plays (that timeline contains all other animations). This is a great way to globally speed up or slow down all animations at once. For example:
...
## Notes [​](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/\#notes "Direct link to Notes")
...
[Previous\\
\\
gsap.effects](https://gsap.com/docs/v3/GSAP/gsap.effects) [Next\\
\\
gsap.ticker](https://gsap.com/docs/v3/GSAP/gsap.ticker)

## Contents

- [Type : Timeline](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#type--timeline)
- [Useful Methods](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#useful-methods)
- [Notes](https://gsap.com/docs/v3/GSAP/gsap.globalTimeline/#notes)
