...
- [Logout](https://gsap.com/community/logout/?csrfKey=47b708513286ba345a9d7aed42fc5b9c)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/timeScale())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/\#details "Direct link to Details")
...
[Previous\\
\\
.time()](https://gsap.com/docs/v3/GSAP/Tween/time()) [Next\\
\\
.totalDuration()](https://gsap.com/docs/v3/GSAP/Tween/totalDuration())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/timeScale()/#details)
