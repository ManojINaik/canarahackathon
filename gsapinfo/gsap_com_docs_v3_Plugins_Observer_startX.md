...
- [Logout](https://gsap.com/community/logout/?csrfKey=323552f0bb41d91fe0b585f03f5a8678)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/startX/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/startX)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/startX/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/startX/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/startX/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/startX/\#details "Direct link to Details")

The `clientX` from the most recent `onPress` touch/pointer event, which refers to the horizontal distance from the left edge of the viewport. This only gets updated if you set the `type` to include "touch" and/or "pointer". It's quite useful for dragging logic.

[Previous\\
\\
.isPressed](https://gsap.com/docs/v3/Plugins/Observer/isPressed) [Next\\
\\
.startY](https://gsap.com/docs/v3/Plugins/Observer/startY)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/startX/#details)
