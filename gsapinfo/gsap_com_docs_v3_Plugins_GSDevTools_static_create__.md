...
- [Logout](https://gsap.com/community/logout/?csrfKey=49b29e1e73d95e76f719ab1ed66e1ded)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/#)
  ...
  - [GSDevTools](https://gsap.com/docs/v3/Plugins/GSDevTools)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/#)
...
### Returns : GSDevTools [​](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/\#returns--gsdevtools "Direct link to Returns : GSDevTools")

A new instance of GSDevTools.

### Details [​](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/\#details "Direct link to Details")
...
[Previous\\
\\
GSDevTools](https://gsap.com/docs/v3/Plugins/GSDevTools) [Next\\
\\
Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)

## Contents

- [Returns : GSDevTools](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/#returns--gsdevtools)
- [Details](https://gsap.com/docs/v3/Plugins/GSDevTools/static.create()/#details)
