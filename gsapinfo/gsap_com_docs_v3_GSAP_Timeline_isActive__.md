...
- [Logout](https://gsap.com/community/logout/?csrfKey=dbc88cec99a5865922b3ecee2f4821bc)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/isActive()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/isActive())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/isActive()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/isActive()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/isActive()/#)
...
- [HTML](https://codepen.io/GreenSock/embed/qBBYLqr/5041bdeb2d1a59f2094863f0a1aeac84?default-tab=result&theme-id=41164#html-box)
- [CSS](https://codepen.io/GreenSock/embed/qBBYLqr/5041bdeb2d1a59f2094863f0a1aeac84?default-tab=result&theme-id=41164#css-box)
- [JS](https://codepen.io/GreenSock/embed/qBBYLqr/5041bdeb2d1a59f2094863f0a1aeac84?default-tab=result&theme-id=41164#js-box)

- [Result](https://codepen.io/GreenSock/embed/qBBYLqr/5041bdeb2d1a59f2094863f0a1aeac84?default-tab=result&theme-id=41164#result-box)
- [Skip Results Iframe](https://codepen.io/GreenSock/embed/qBBYLqr/5041bdeb2d1a59f2094863f0a1aeac84?default-tab=result&theme-id=41164#resources-link)

[EDIT ON](https://codepen.io/GreenSock/pen/qBBYLqr "Edit on CodePen")
...
### You can only toggle direction when the tween is not active

toggle direction (only when tween is not active)
...
1. [https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js](https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js)
2. [https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/gsap-latest-beta.min.js](https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/gsap-latest-beta.min.js)
...
[Previous\\
\\
.invalidate()](https://gsap.com/docs/v3/GSAP/Timeline/invalidate()) [Next\\
\\
.iteration()](https://gsap.com/docs/v3/GSAP/Timeline/iteration())

## Contents

- [Returns : Boolean](https://gsap.com/docs/v3/GSAP/Timeline/isActive()/#returns--boolean)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/isActive()/#details)
