...
- [Logout](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/\#details "Direct link to Details")
...
## Events [​](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/\#events "Direct link to Events")
...
## Usage [​](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/\#usage "Direct link to Usage")
...
[Previous\\
\\
.zIndex](https://gsap.com/docs/v3/Plugins/Draggable/zIndex) [Next\\
\\
.applyBounds()](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#details)
- [Events](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#events)
- [Usage](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()/#usage)
