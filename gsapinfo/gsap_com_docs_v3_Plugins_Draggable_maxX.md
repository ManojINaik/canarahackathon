...
- [Logout](https://gsap.com/community/logout/?csrfKey=27cc0a0fa59008317cc55a75ede7b3ea)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/maxX/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/maxX)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/maxX/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/maxX/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/maxX/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/maxX/\#details "Direct link to Details")
...
[Previous\\
\\
.maxRotation](https://gsap.com/docs/v3/Plugins/Draggable/maxRotation) [Next\\
\\
.maxY](https://gsap.com/docs/v3/Plugins/Draggable/maxY)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/maxX/#details)
