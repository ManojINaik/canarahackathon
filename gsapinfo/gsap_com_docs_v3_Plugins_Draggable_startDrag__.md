...
- [Logout](https://gsap.com/community/logout/?csrfKey=25419de9ac48e112ae67f5a1399aaca8)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/startDrag())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()/\#details "Direct link to Details")
...
[Previous\\
\\
.kill()](https://gsap.com/docs/v3/Plugins/Draggable/kill()) [Next\\
\\
Draggable.timeSinceDrag()](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()/#details)
