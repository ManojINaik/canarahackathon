...
- [Logout](https://gsap.com/community/logout/?csrfKey=916bb3fbdb24ff68eaaffb713668f032)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/#)
...
### Returns : String [​](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/\#returns--string "Direct link to Returns : String")

The axis along which movement is locked during that particular drag.

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/\#details "Direct link to Details")
...
[Previous\\
\\
.lockAxis](https://gsap.com/docs/v3/Plugins/Draggable/lockAxis) [Next\\
\\
.maxRotation](https://gsap.com/docs/v3/Plugins/Draggable/maxRotation)

## Contents

- [Returns : String](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/#returns--string)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/lockedAxis/#details)
