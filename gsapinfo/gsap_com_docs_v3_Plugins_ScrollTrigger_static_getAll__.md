...
- [Logout](https://gsap.com/community/logout/?csrfKey=4411c255e9c26a6eb999946567a3b8f5)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/#)
...
### Returns : Array [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/\#returns--array "Direct link to Returns : Array")

Returns an Array of all ScrollTrigger instances

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/\#details "Direct link to Details")

Returns an Array of all ScrollTrigger instances

[Previous\\
\\
.enable()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()) [Next\\
\\
ScrollTrigger.getById()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getById())

## Contents

- [Returns : Array](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/#returns--array)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll()/#details)
