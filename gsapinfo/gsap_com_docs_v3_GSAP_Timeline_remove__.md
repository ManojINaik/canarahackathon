...
- [Logout](https://gsap.com/community/logout/?csrfKey=a20a8e7b68ef66e495ad66194def0c43)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/remove()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/remove())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/remove()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/remove()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/remove()/#)
...
[Previous\\
\\
.recent()](https://gsap.com/docs/v3/GSAP/Timeline/recent()) [Next\\
\\
.removeLabel()](https://gsap.com/docs/v3/GSAP/Timeline/removeLabel())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/remove()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/remove()/#details)
