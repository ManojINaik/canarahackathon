...
- [Logout](https://gsap.com/community/logout/?csrfKey=b1f0283820f801aef13eb23dc54a3631)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/repeat()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/repeat())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/repeat()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/repeat()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/repeat()/#)
...
[Previous\\
\\
.removePause()](https://gsap.com/docs/v3/GSAP/Timeline/removePause()) [Next\\
\\
.repeatDelay()](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/repeat()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/repeat()/#details)
