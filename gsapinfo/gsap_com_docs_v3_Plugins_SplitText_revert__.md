...
- [Logout](https://gsap.com/community/logout/?csrfKey=26c843883ae152b691a827fc40d26b8e)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/SplitText/revert()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/SplitText/revert())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/SplitText/revert()/#)
  ...
  - [SplitText](https://gsap.com/docs/v3/Plugins/SplitText/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/SplitText/revert()/#)
    ...
    - [constructor](https://gsap.com/docs/v3/Plugins/SplitText/revert()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/SplitText/revert()/\#details "Direct link to Details")

Reverts to the original content (the `innerHTML` before the split).

[Previous\\
\\
.words](https://gsap.com/docs/v3/Plugins/SplitText/words) [Next\\
\\
.split()](https://gsap.com/docs/v3/Plugins/SplitText/split())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/SplitText/revert()/#details)
