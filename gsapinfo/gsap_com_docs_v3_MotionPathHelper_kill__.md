...
- [Logout](https://gsap.com/community/logout/?csrfKey=4c424fb27e6856ad1ff476a155f8fcf0)
...
[Skip to main content](https://gsap.com/docs/v3/MotionPathHelper/kill()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/MotionPathHelper/kill())
...
- [more plugins](https://gsap.com/docs/v3/MotionPathHelper/kill()/#)
  ...
  - [MotionPathHelper](https://gsap.com/docs/v3/Plugins/MotionPathHelper/)
    ...
    - [methods](https://gsap.com/docs/v3/MotionPathHelper/kill()/#)
...
### Details [​](https://gsap.com/docs/v3/MotionPathHelper/kill()/\#details "Direct link to Details")
...
### Details [​](https://gsap.com/docs/v3/MotionPathHelper/kill()/\#details-1 "Direct link to Details")

Kills the MotionPathHelper instance, removing the path editing elements and "Copy" button from the DOM.

[Previous\\
\\
MotionPathHelper](https://gsap.com/docs/v3/Plugins/MotionPathHelper/) [Next\\
\\
MotionPathHelper.editPath()](https://gsap.com/docs/v3/MotionPathHelper/static.editPath())

## Contents

- [Details](https://gsap.com/docs/v3/MotionPathHelper/kill()/#details)
- [Details](https://gsap.com/docs/v3/MotionPathHelper/kill()/#details-1)
