...
- [Logout](https://gsap.com/community/logout/?csrfKey=a0fbae116121e69fa8c321da2a47a3b9)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#)
...
[Previous\\
\\
.endTime()](https://gsap.com/docs/v3/GSAP/Timeline/endTime()) [Next\\
\\
.from()](https://gsap.com/docs/v3/GSAP/Timeline/from())

## Contents

- [Returns : \[Function \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#returns--function--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback()/#details)
