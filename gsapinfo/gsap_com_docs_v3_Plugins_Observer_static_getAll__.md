...
- [Logout](https://gsap.com/community/logout/?csrfKey=ebbb6b02e3a8385e3986350f62164bba)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/static.getAll())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/#)
...
### Returns : Array [​](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/\#returns--array "Direct link to Returns : Array")

An Array of Observer instances

### Details [​](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/\#details "Direct link to Details")
...
[Previous\\
\\
Observer.create()](https://gsap.com/docs/v3/Plugins/Observer/static.create()) [Next\\
\\
Observer.getById()](https://gsap.com/docs/v3/Plugins/Observer/static.getById())

## Contents

- [Returns : Array](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/#returns--array)
- [Details](https://gsap.com/docs/v3/Plugins/Observer/static.getAll()/#details)
