...
- [Logout](https://gsap.com/community/logout/?csrfKey=3547413d960da2e7935ced338a751916)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/startX/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/startX)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/startX/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/startX/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/startX/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/startX/\#details "Direct link to Details")
...
[Previous\\
\\
.rotation](https://gsap.com/docs/v3/Plugins/Draggable/rotation) [Next\\
\\
.startY](https://gsap.com/docs/v3/Plugins/Draggable/startY)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/startX/#details)
