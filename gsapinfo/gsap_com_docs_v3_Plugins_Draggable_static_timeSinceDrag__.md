...
- [Logout](https://gsap.com/community/logout/?csrfKey=98a133218bcea31ab98661e14e73bf2c)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/#)
...
### Returns : Number [​](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/\#returns--number "Direct link to Returns : Number")

The time (in seconds) since the last drag ended.

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/\#details "Direct link to Details")
...
[Previous\\
\\
.startDrag()](https://gsap.com/docs/v3/Plugins/Draggable/startDrag()) [Next\\
\\
.update()](https://gsap.com/docs/v3/Plugins/Draggable/update())

## Contents

- [Returns : Number](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/#returns--number)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()/#details)
