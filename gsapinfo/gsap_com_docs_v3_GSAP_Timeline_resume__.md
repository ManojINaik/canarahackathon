...
- [Logout](https://gsap.com/community/logout/?csrfKey=5e586480fa241df8da90b4bd88fd8095)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/resume())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#)
...
[Previous\\
\\
.restart()](https://gsap.com/docs/v3/GSAP/Timeline/restart()) [Next\\
\\
.reverse()](https://gsap.com/docs/v3/GSAP/Timeline/reverse())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/resume()/#details)
