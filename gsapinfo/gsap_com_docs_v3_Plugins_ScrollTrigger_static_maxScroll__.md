...
- [Logout](https://gsap.com/community/logout/?csrfKey=108a2ec6e32c4e3870f6b3b483547c83)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()/#)
...
[Previous\\
\\
ScrollTrigger.matchMedia()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.matchMedia()) [Next\\
\\
.next()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/next())

## Contents

- [Returns : Number](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()/#returns--number)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.maxScroll()/#details)
