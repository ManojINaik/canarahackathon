...
- [Logout](https://gsap.com/community/logout/?csrfKey=12559bafd31be149e711c8abbbbe9375)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/time()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/time())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/time()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/time()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/time()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Tween/time()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/time()/\#details "Direct link to Details")
...
[Previous\\
\\
.then()](https://gsap.com/docs/v3/GSAP/Tween/then()) [Next\\
\\
.timeScale()](https://gsap.com/docs/v3/GSAP/Tween/timeScale())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/time()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/time()/#details)
