...
- [Logout](https://gsap.com/community/logout/?csrfKey=c4c221adefd531daff1caa1a7e6cb77c)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack()/#)
...
## Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack()/\#details "Direct link to Details")
...
[Previous\\
\\
.track](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.track) [Next\\
\\
MorphSVG](https://gsap.com/docs/v3/Plugins/MorphSVGPlugin)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.untrack()/#details)
