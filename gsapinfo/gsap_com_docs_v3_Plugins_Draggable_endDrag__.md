...
- [Logout](https://gsap.com/community/logout/?csrfKey=8063a3af1c9b89d876274494d5e25cc8)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/endDrag())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()/\#details "Direct link to Details")
...
[Previous\\
\\
.enabled()](https://gsap.com/docs/v3/Plugins/Draggable/enabled()) [Next\\
\\
Draggable.get()](https://gsap.com/docs/v3/Plugins/Draggable/static.get())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/endDrag()/#details)
