...
- [Logout](https://gsap.com/community/logout/?csrfKey=b562a7cab218365e02a30c436e00e1a8)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper())
...
- [ScrollSmoother](https://gsap.com/docs/v3/Plugins/ScrollSmoother/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#)
...
### Returns : Element \| self [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/\#returns--element--self "Direct link to Returns : Element | self")

The wrapper Element (or the ScrollSmoother instance if used as a setter)

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/\#details "Direct link to Details")

Gets/Sets the wrapper element.

### Getter [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/\#getter "Direct link to Getter")
...
### Setter [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/\#setter "Direct link to Setter")
...
[Previous\\
\\
ScrollSmoother.get()](https://gsap.com/docs/v3/Plugins/ScrollSmoother/static.get()) [Next\\
\\
Flip](https://gsap.com/docs/v3/Plugins/Flip/)

## Contents

- [Returns : Element \| self](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#returns--element--self)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#details)
- [Getter](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#getter)
- [Setter](https://gsap.com/docs/v3/Plugins/ScrollSmoother/wrapper()/#setter)
