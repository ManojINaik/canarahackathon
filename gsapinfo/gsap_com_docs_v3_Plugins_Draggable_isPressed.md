...
- [Logout](https://gsap.com/community/logout/?csrfKey=6413ce77eb8c4d8e4a7921abb2909af7)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/isPressed/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/isPressed)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/isPressed/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/isPressed/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/isPressed/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/isPressed/\#details "Direct link to Details")

If the Draggable is being pressed, this will be `true`

[Previous\\
\\
.endY](https://gsap.com/docs/v3/Plugins/Draggable/endY) [Next\\
\\
.isThrowing](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/isPressed/#details)
