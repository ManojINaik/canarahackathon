...
- [Logout](https://gsap.com/community/logout/?csrfKey=c5b1a096d025d2f2a44528ec0bde4ddb)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/getById()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/getById())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/getById()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/getById()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/getById()/#)
...
### Returns : Animation [​](https://gsap.com/docs/v3/GSAP/Timeline/getById()/\#returns--animation "Direct link to Returns : Animation")

The Tween or Timeline associated with the provided ID.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/getById()/\#details "Direct link to Details")
...
[Previous\\
\\
.fromTo()](https://gsap.com/docs/v3/GSAP/Timeline/fromTo()) [Next\\
\\
.getChildren()](https://gsap.com/docs/v3/GSAP/Timeline/getChildren())

## Contents

- [Returns : Animation](https://gsap.com/docs/v3/GSAP/Timeline/getById()/#returns--animation)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/getById()/#details)
