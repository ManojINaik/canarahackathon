...
- [Logout](https://gsap.com/community/logout/?csrfKey=73f8e1cb9d420b37c55226c58ce4ae81)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/recent()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/recent())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/recent()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/recent()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/recent()/#)
...
[Previous\\
\\
.progress()](https://gsap.com/docs/v3/GSAP/Timeline/progress()) [Next\\
\\
.remove()](https://gsap.com/docs/v3/GSAP/Timeline/remove())

## Contents

- [Details](https://gsap.com/docs/v3/GSAP/Timeline/recent()/#details)
