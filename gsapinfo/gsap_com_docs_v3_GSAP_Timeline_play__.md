...
- [Logout](https://gsap.com/community/logout/?csrfKey=c1bd4af7958b5530594de9c56f1b6ce4)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/play()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/play())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/play()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/play()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/play()/#)
...
### Returns : self [​](https://gsap.com/docs/v3/GSAP/Timeline/play()/\#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/play()/\#details "Direct link to Details")
...
[Previous\\
\\
.paused()](https://gsap.com/docs/v3/GSAP/Timeline/paused()) [Next\\
\\
.previousLabel()](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/play()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/play()/#details)
