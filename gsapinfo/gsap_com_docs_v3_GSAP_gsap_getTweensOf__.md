...
- [Logout](https://gsap.com/community/logout/?csrfKey=08d56ef08d56ed22a310c7a89ef622fb)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf())
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#)
...
### Returns : Array [​](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/\#returns--array "Direct link to Returns : Array")
...
### Details [​](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/\#details "Direct link to Details")
...
[Previous\\
\\
gsap.getProperty()](https://gsap.com/docs/v3/GSAP/gsap.getProperty()) [Next\\
\\
gsap.isTweening()](https://gsap.com/docs/v3/GSAP/gsap.isTweening())

## Contents

- [Returns : Array](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#returns--array)
- [Details](https://gsap.com/docs/v3/GSAP/gsap.getTweensOf()/#details)
