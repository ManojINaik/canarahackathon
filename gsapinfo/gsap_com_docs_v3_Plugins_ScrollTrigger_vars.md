...
- [Logout](https://gsap.com/community/logout/?csrfKey=e093cdb3648f0f8948ef9d93c7b2eda3)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars)
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/\#details "Direct link to Details")

\[read-only\] The vars configuration object used to create the ScrollTrigger instance.

## Example [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/\#example "Direct link to Example")
...
[Previous\\
\\
.trigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/trigger) [Next\\
\\
ScrollTrigger.batch()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.batch())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/vars/#example)
