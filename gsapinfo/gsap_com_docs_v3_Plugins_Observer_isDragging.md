...
- [Logout](https://gsap.com/community/logout/?csrfKey=4432b6ac712eeaf970b07f8f6f144dc1)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/isDragging/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/isDragging)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/isDragging/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/isDragging/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/isDragging/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/isDragging/\#details "Direct link to Details")

When the user presses on the `target` and drags more than the `dragMinimum` (0 by default), `isDragging` is set to `true` until the touch/pointer is released (even if the user continues dragging _outside the bounds of the target_).

[Previous\\
\\
.event](https://gsap.com/docs/v3/Plugins/Observer/event) [Next\\
\\
.isEnabled](https://gsap.com/docs/v3/Plugins/Observer/isEnabled)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/isDragging/#details)
