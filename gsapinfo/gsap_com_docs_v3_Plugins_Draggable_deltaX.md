...
- [Logout](https://gsap.com/community/logout/?csrfKey=6d5bdca9814adbdd28494194b1f34014)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/deltaX/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/deltaX)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/deltaX/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/deltaX/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/deltaX/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/deltaX/\#details "Direct link to Details")
...
[Previous\\
\\
.autoScroll](https://gsap.com/docs/v3/Plugins/Draggable/autoScroll) [Next\\
\\
.deltaY](https://gsap.com/docs/v3/Plugins/Draggable/deltaY)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/deltaX/#details)
