...
- [Logout](https://gsap.com/community/logout/?csrfKey=a55f744fd653f5932de1587ee19cbf74)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.defaults()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.defaults())
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.defaults()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.defaults()/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.defaults()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.defaults()/#)
...
[Previous\\
\\
gsap.context()](https://gsap.com/docs/v3/GSAP/gsap.context()) [Next\\
\\
gsap.delayedCall()](https://gsap.com/docs/v3/GSAP/gsap.delayedCall())
