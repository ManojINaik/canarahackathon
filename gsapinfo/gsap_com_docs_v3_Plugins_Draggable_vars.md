...
- [Logout](https://gsap.com/community/logout/?csrfKey=4f55a6918a62a96c2b9231afd24c9b71)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/vars/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/vars)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/vars/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/vars/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/vars/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/vars/\#details "Direct link to Details")
...
[Previous\\
\\
.tween](https://gsap.com/docs/v3/Plugins/Draggable/tween) [Next\\
\\
.x](https://gsap.com/docs/v3/Plugins/Draggable/x)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/vars/#details)
