...
- [Logout](https://gsap.com/community/logout/?csrfKey=756911756ab6e4ab1a28ffc6e6c6eea3)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/totalProgress())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/\#details "Direct link to Details")
...
[Previous\\
\\
.totalDuration()](https://gsap.com/docs/v3/GSAP/Tween/totalDuration()) [Next\\
\\
.totalTime()](https://gsap.com/docs/v3/GSAP/Tween/totalTime())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()/#details)
