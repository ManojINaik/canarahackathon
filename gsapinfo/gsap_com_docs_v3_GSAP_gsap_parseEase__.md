...
- [Logout](https://gsap.com/community/logout/?csrfKey=7ba8ecb00ec60ca28167e9343ada7d19)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.parseEase()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.parseEase())
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.parseEase()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.parseEase()/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.parseEase()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.parseEase()/#)
...
For a more complex use case, see the [blended eases](https://gsap.com/docs/v3/HelperFunctions#blend-eases) helper function.

[Previous\\
\\
gsap.matchMediaRefresh()](https://gsap.com/docs/v3/GSAP/gsap.matchMediaRefresh()) [Next\\
\\
gsap.quickSetter()](https://gsap.com/docs/v3/GSAP/gsap.quickSetter())

## Contents

- [Returns : easing function](https://gsap.com/docs/v3/GSAP/gsap.parseEase()/#returns--easing-function)
