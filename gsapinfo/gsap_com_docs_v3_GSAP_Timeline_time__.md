...
- [Logout](https://gsap.com/community/logout/?csrfKey=bac343384126a448e51bb3eabc5679d9)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/time()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/time())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/time()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/time()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/time()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/time()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/time()/\#details "Direct link to Details")
...
[Previous\\
\\
.then()](https://gsap.com/docs/v3/GSAP/Timeline/then()) [Next\\
\\
.timeScale()](https://gsap.com/docs/v3/GSAP/Timeline/timeScale())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/time()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/time()/#details)
