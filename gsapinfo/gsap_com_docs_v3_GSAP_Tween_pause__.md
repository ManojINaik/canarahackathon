...
- [Logout](https://gsap.com/community/logout/?csrfKey=62c655ac8d0b52242e76855d47bc8997)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/pause()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/pause())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/pause()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/pause()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/pause()/#)
...
### Returns : self [​](https://gsap.com/docs/v3/GSAP/Tween/pause()/\#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/pause()/\#details "Direct link to Details")
...
[Previous\\
\\
.kill()](https://gsap.com/docs/v3/GSAP/Tween/kill()) [Next\\
\\
.paused()](https://gsap.com/docs/v3/GSAP/Tween/paused())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Tween/pause()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/pause()/#details)
