...
- [Logout](https://gsap.com/community/logout/?csrfKey=9458a10aee99d0365f712c08efca00ec)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.version/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.version)
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.version/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.version/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.version/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.version/#)
...
### Type : String [​](https://gsap.com/docs/v3/GSAP/gsap.version/\#type--string "Direct link to Type : String")

The GSAP version that is currently being used (in String form). For example, `3.12.7`

[Previous\\
\\
gsap.utils](https://gsap.com/docs/v3/GSAP/gsap.utils) [Next\\
\\
gsap.config()](https://gsap.com/docs/v3/GSAP/gsap.config())

## Contents

- [Type : String](https://gsap.com/docs/v3/GSAP/gsap.version/#type--string)
