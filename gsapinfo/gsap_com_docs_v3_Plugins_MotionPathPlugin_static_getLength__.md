...
- [Logout](https://gsap.com/community/logout/?csrfKey=2c21ebb5a442ed560c2de51792773a40)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/#)
  ...
  - [MotionPath](https://gsap.com/docs/v3/Plugins/MotionPathPlugin)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/#)
...
### Returns : Number [​](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/\#returns--number "Direct link to Returns : Number")

The length of the path

### Details [​](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/\#details "Direct link to Details")

Returns the length of a path

[Previous\\
\\
MotionPathPlugin.getGlobalMatrix()](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getGlobalMatrix()) [Next\\
\\
MotionPathPlugin.getPositionOnPath()](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getPositionOnPath())

## Contents

- [Returns : Number](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/#returns--number)
- [Details](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.getLength()/#details)
