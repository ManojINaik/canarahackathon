...
- [Logout](https://gsap.com/community/logout/?csrfKey=cf0e9d22a6f1aaf32d14f7d94c15752a)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/y/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/y)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/y/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/y/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/y/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/y/\#details "Direct link to Details")
...
[Previous\\
\\
.x](https://gsap.com/docs/v3/Plugins/Draggable/x) [Next\\
\\
.zIndex](https://gsap.com/docs/v3/Plugins/Draggable/zIndex)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/y/#details)
