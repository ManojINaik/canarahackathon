...
- [Logout](https://gsap.com/community/logout/?csrfKey=69273bc40e9fb31839c223a93c74798d)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/gsap.getById()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/gsap.getById())
...
- [GSAP](https://gsap.com/docs/v3/GSAP/)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/gsap.getById()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/gsap.getById()/#)
  ...
  - [Internal Plugins](https://gsap.com/docs/v3/GSAP/gsap.getById()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/gsap.getById()/#)
...
### Returns : [Tween](https://gsap.com/docs/v3/GSAP/Tween) or [Timeline](https://gsap.com/docs/v3/GSAP/Timeline) [​](https://gsap.com/docs/v3/GSAP/gsap.getById()/\#returns--tween-or-timeline "Direct link to returns--tween-or-timeline")

The tween or timeline associated with the given ID. Returns `undefined` if no tween or timeline has that ID.

### Details [​](https://gsap.com/docs/v3/GSAP/gsap.getById()/\#details "Direct link to Details")
...
[Previous\\
\\
gsap.fromTo()](https://gsap.com/docs/v3/GSAP/gsap.fromTo()) [Next\\
\\
gsap.getProperty()](https://gsap.com/docs/v3/GSAP/gsap.getProperty())

## Contents

- [Returns : Tween or Timeline](https://gsap.com/docs/v3/GSAP/gsap.getById()/#returns--tween-or-timeline)
- [Details](https://gsap.com/docs/v3/GSAP/gsap.getById()/#details)
