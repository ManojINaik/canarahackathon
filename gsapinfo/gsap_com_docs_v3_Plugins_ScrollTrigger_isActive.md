...
- [Logout](https://gsap.com/community/logout/?csrfKey=8acf665971c7d5e7fd48a7b42cdb1feb)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive)
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive/#)
...
[Previous\\
\\
.end](https://gsap.com/docs/v3/Plugins/ScrollTrigger/end) [Next\\
\\
ScrollTrigger.isTouch](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.isTouch)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/isActive/#example)
