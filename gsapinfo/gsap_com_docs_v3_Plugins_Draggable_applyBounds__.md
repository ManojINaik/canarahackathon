...
- [Logout](https://gsap.com/community/logout/?csrfKey=bd38c6def6d932bd6852e9a2482b2b82)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds()/\#details "Direct link to Details")
...
[Previous\\
\\
.addEventListener()](https://gsap.com/docs/v3/Plugins/Draggable/addEventListener()) [Next\\
\\
Draggable.create()](https://gsap.com/docs/v3/Plugins/Draggable/static.create())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/applyBounds()/#details)
