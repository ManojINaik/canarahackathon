...
- [Logout](https://gsap.com/community/logout/?csrfKey=62105401f4fc77548222c441e85b10ed)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/iteration())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/\#details "Direct link to Details")
...
[Previous\\
\\
.isActive()](https://gsap.com/docs/v3/GSAP/Timeline/isActive()) [Next\\
\\
.kill()](https://gsap.com/docs/v3/GSAP/Timeline/kill())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/iteration()/#details)
