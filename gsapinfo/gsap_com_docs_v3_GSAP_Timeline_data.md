...
- [Logout](https://gsap.com/community/logout/?csrfKey=3263b0ccad1b828e2aec1def5f61180c)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/data/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/data)
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/data/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/data/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/data/#)
...
### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/data/\#details "Direct link to Details")

A place to store any data you want (initially populated with `vars.data` if it exists).

[Previous\\
\\
.autoRemoveChildren](https://gsap.com/docs/v3/GSAP/Timeline/autoRemoveChildren) [Next\\
\\
.labels](https://gsap.com/docs/v3/GSAP/Timeline/labels)

## Contents

- [Details](https://gsap.com/docs/v3/GSAP/Timeline/data/#details)
