...
- [Logout](https://gsap.com/community/logout/?csrfKey=d98bcd24814432b61416ab58cb9378de)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing/\#details "Direct link to Details")

_Boolean_ \- `isThrowing` will be `true` if the Draggable's target is currently being animated by an inertia tween.

[Previous\\
\\
.isPressed](https://gsap.com/docs/v3/Plugins/Draggable/isPressed) [Next\\
\\
.lockAxis](https://gsap.com/docs/v3/Plugins/Draggable/lockAxis)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Draggable/isThrowing/#details)
