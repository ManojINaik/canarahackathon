...
- [Logout](https://gsap.com/community/logout/?csrfKey=28079cab22937cd73619a8d4de21095e)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/#)
...
### Returns : Tween [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/\#returns--tween "Direct link to Returns : Tween")

The scrub (or snap) Tween instance

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/\#details "Direct link to Details")
...
[Previous\\
\\
ScrollTrigger.getById()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getById()) [Next\\
\\
.getVelocity()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getVelocity())

## Contents

- [Returns : Tween](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/#returns--tween)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/getTween()/#details)
