...
- [Logout](https://gsap.com/community/logout/?csrfKey=aaaa4dfe75ad5b6b7e47e7cbf9422d3c)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/endTime())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/\#returns--number--self "Direct link to returns--number--self")

The end time of the timeline according to its parent timeline.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/\#details "Direct link to Details")
...
[Previous\\
\\
.duration()](https://gsap.com/docs/v3/GSAP/Timeline/duration()) [Next\\
\\
.eventCallback()](https://gsap.com/docs/v3/GSAP/Timeline/eventCallback())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/endTime()/#details)
