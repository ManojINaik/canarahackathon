...
- [Logout](https://gsap.com/community/logout/?csrfKey=689b72d1b5f7d8c61ff41068511e8555)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/then()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/then())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/then()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/then()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/then()/#)
...
[Previous\\
\\
.startTime()](https://gsap.com/docs/v3/GSAP/Timeline/startTime()) [Next\\
\\
.time()](https://gsap.com/docs/v3/GSAP/Timeline/time())

## Contents

- [Returns : Promise](https://gsap.com/docs/v3/GSAP/Timeline/then()/#returns--promise)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/then()/#details)
