...
- [Logout](https://gsap.com/community/logout/?csrfKey=e7438bbf71ee7d19827d66f34419b4c7)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults()/#)
...
[Previous\\
\\
ScrollTrigger.create()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()) [Next\\
\\
.disable()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/disable())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults()/#example)
