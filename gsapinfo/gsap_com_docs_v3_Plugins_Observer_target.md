...
- [Logout](https://gsap.com/docs/v3/Plugins/Observer/target/#)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/target/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/target)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/target/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/target/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/target/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/target/\#details "Direct link to Details")

The target Element

[Previous\\
\\
Observer.isTouch](https://gsap.com/docs/v3/Plugins/Observer/static.isTouch) [Next\\
\\
.vars](https://gsap.com/docs/v3/Plugins/Observer/vars)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/target/#details)
