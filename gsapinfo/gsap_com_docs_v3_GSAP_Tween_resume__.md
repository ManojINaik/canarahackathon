...
- [Logout](https://gsap.com/community/logout/?csrfKey=2cc8ad79ff19c50b9b1bc2bfd6aac03a)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/resume()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/resume())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/resume()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/resume()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/resume()/#)
...
[Previous\\
\\
.restart()](https://gsap.com/docs/v3/GSAP/Tween/restart()) [Next\\
\\
.reverse()](https://gsap.com/docs/v3/GSAP/Tween/reverse())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Tween/resume()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/resume()/#details)
