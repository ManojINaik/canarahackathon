...
- [Logout](https://gsap.com/community/logout/?csrfKey=0943a61513fec2596734e91fe1c031bf)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/reversed())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/#)
...
### Returns : \[Boolean \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/\#returns--boolean--self "Direct link to returns--boolean--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/\#details "Direct link to Details")
...
[Previous\\
\\
.reverse()](https://gsap.com/docs/v3/GSAP/Timeline/reverse()) [Next\\
\\
.revert()](https://gsap.com/docs/v3/GSAP/Timeline/revert())

## Contents

- [Returns : \[Boolean \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/#returns--boolean--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/reversed()/#details)
