...
- [Logout](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/#)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger)
...
- [ScrollSmoother](https://gsap.com/docs/v3/Plugins/ScrollSmoother/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/\#details "Direct link to Details")

The [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger) instance that ScrollSmoother created internally to manage the smooth scrolling effect of the page.
...
[Previous\\
\\
.progress](https://gsap.com/docs/v3/Plugins/ScrollSmoother/progress) [Next\\
\\
.vars](https://gsap.com/docs/v3/Plugins/ScrollSmoother/vars)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollSmoother/scrollTrigger/#details)
