...
- [Logout](https://gsap.com/community/logout/?csrfKey=a14763ba9ac8fafa6c365937381d4a19)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.stringToRawPath()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.stringToRawPath())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.stringToRawPath()/#)
  ...
  - [MotionPath](https://gsap.com/docs/v3/Plugins/MotionPathPlugin)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.stringToRawPath()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.stringToRawPath()/\#details "Direct link to Details")
...
There is also a corresponding [`MotionPathPlugin.rawPathToString()`](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.rawPathToString()) method so that you can convert back and forth.

[Previous\\
\\
MotionPathPlugin.sliceRawPath()](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.sliceRawPath()) [Next\\
\\
MotionPathHelper](https://gsap.com/docs/v3/Plugins/MotionPathHelper/)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/MotionPathPlugin/static.stringToRawPath()/#details)
