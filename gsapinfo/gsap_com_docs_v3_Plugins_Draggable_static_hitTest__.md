...
- [Logout](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()/#)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest())
...
### Returns : Boolean [​](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()/\#returns--boolean "Direct link to Returns : Boolean")

Returns `true` if an overlap is sensed (according to the threshold), `false` otherwise.

#### loading...

[iframe](https://codepen.io/GreenSock/embed/JjQRzNy?default-tab=result&theme-id=41164)

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()/\#details "Direct link to Details")
...
[iframe](https://codepen.io/GreenSock/embed/GFBvn?default-tab=result&theme-id=41164)
...
[Previous\\
\\
.getDirection()](https://gsap.com/docs/v3/Plugins/Draggable/getDirection()) [Next\\
\\
.kill()](https://gsap.com/docs/v3/Plugins/Draggable/kill())

## Contents

- [Returns : Boolean](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()/#returns--boolean)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()/#details)
