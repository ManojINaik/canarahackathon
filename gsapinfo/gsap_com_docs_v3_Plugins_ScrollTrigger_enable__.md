...
- [Logout](https://gsap.com/community/logout/?csrfKey=2199ccbebfdd79ac2ae265b1d23d0358)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()/\#details "Direct link to Details")

Enables the ScrollTrigger instance

[Previous\\
\\
.disable()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/disable()) [Next\\
\\
ScrollTrigger.getAll()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.getAll())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/enable()/#details)
