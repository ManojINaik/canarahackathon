...
- [Logout](https://gsap.com/community/logout/?csrfKey=bc21e3480d7813dd465508363668602b)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles())
...
- [ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/)
  ...
  - [properties](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()/#)
  ...
  - [methods](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()/#)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()/#)
...
[Previous\\
\\
ScrollTrigger.removeEventListener()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.removeEventListener()) [Next\\
\\
.scroll()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/scroll())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.saveStyles()/#example)
