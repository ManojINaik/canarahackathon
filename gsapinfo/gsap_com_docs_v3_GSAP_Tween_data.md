...
- [Logout](https://gsap.com/community/logout/?csrfKey=a16caea5d7bc77b8d8774e646109b8cb)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/data/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/data)
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/data/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/data/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/data/#)
...
### Details [​](https://gsap.com/docs/v3/GSAP/Tween/data/\#details "Direct link to Details")

A place to store any data you want (initially populated with `vars.data` if it exists).

[Previous\\
\\
Tween](https://gsap.com/docs/v3/GSAP/Tween) [Next\\
\\
.ratio](https://gsap.com/docs/v3/GSAP/Tween/ratio)

## Contents

- [Details](https://gsap.com/docs/v3/GSAP/Tween/data/#details)
