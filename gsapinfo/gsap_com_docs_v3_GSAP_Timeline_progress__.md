...
- [Logout](https://gsap.com/community/logout/?csrfKey=dbff7938f73663ca843871945af7dc8e)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/progress()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/progress())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/progress()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/progress()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/progress()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/progress()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/progress()/\#details "Direct link to Details")
...
[Previous\\
\\
.previousLabel()](https://gsap.com/docs/v3/GSAP/Timeline/previousLabel()) [Next\\
\\
.recent()](https://gsap.com/docs/v3/GSAP/Timeline/recent())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/progress()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/progress()/#details)
