...
- [Logout](https://gsap.com/community/logout/?csrfKey=f35fc8045078ce78e3b03b442e29ff8c)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/endTime()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/endTime())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/endTime()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/endTime()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/endTime()/#)
...
### Returns : Number [​](https://gsap.com/docs/v3/GSAP/Tween/endTime()/\#returns--number "Direct link to Returns : Number")

Returns the time at which the animation will finish according to the parent timeline's local time.

### Details [​](https://gsap.com/docs/v3/GSAP/Tween/endTime()/\#details "Direct link to Details")
...
[Previous\\
\\
.duration()](https://gsap.com/docs/v3/GSAP/Tween/duration()) [Next\\
\\
.eventCallback()](https://gsap.com/docs/v3/GSAP/Tween/eventCallback())

## Contents

- [Returns : Number](https://gsap.com/docs/v3/GSAP/Tween/endTime()/#returns--number)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/endTime()/#details)
