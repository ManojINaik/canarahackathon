...
- [Logout](https://gsap.com/community/logout/?csrfKey=b6a161c56fb074a0d5bb5756dde994c2)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/#)
...
### Returns : Boolean [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/\#returns--boolean "Direct link to Returns : Boolean")

Returns `true` if the property is being tracked, `false` if not.

* * *

## Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/\#details "Direct link to Details")

Allows you to discern whether the velocity of a particular property is being tracked.

[Previous\\
\\
.isTracking](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking()) [Next\\
\\
.removeProp](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.removeProp())

## Contents

- [Returns : Boolean](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/#returns--boolean)
- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTrackingProp()/#details)
