...
- [Logout](https://gsap.com/community/logout/?csrfKey=c6673278a861ee511ddfcae7160a4f9f)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/isPressed/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/isPressed)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/isPressed/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/isPressed/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/isPressed/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/isPressed/\#details "Direct link to Details")

Set to `true` while the user presses on the target (only applies to `type` of "pointer" and "touch")

[Previous\\
\\
.isEnabled](https://gsap.com/docs/v3/Plugins/Observer/isEnabled) [Next\\
\\
.startX](https://gsap.com/docs/v3/Plugins/Observer/startX)

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/isPressed/#details)
