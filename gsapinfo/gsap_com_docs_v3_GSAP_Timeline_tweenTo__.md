...
- [Logout](https://gsap.com/community/logout/?csrfKey=8482baacc5b93a7b0203215532056200)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo()/#)
...
[Previous\\
\\
.tweenFromTo()](https://gsap.com/docs/v3/GSAP/Timeline/tweenFromTo()) [Next\\
\\
.yoyo()](https://gsap.com/docs/v3/GSAP/Timeline/yoyo())

## Contents

- [Returns : Tween](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo()/#returns--tween)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/tweenTo()/#details)
