...
- [Logout](https://gsap.com/community/logout/?csrfKey=7bc12eaa7341acbd222a55f7c1ec9ba9)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/seek()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/seek())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/seek()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/seek()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/seek()/#)
...
### Returns : self [​](https://gsap.com/docs/v3/GSAP/Timeline/seek()/\#returns--self "Direct link to Returns : self")

self (makes chaining easier)

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/seek()/\#details "Direct link to Details")
...
[Previous\\
\\
.revert()](https://gsap.com/docs/v3/GSAP/Timeline/revert()) [Next\\
\\
.set()](https://gsap.com/docs/v3/GSAP/Timeline/set())

## Contents

- [Returns : self](https://gsap.com/docs/v3/GSAP/Timeline/seek()/#returns--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/seek()/#details)
