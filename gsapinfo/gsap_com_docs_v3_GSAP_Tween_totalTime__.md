...
- [Logout](https://gsap.com/community/logout/?csrfKey=edde0e208160823bf8b8db67b10c9671)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/totalTime()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/totalTime())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/totalTime()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/totalTime()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/totalTime()/#)
...
[Previous\\
\\
.totalProgress()](https://gsap.com/docs/v3/GSAP/Tween/totalProgress()) [Next\\
\\
.yoyo()](https://gsap.com/docs/v3/GSAP/Tween/yoyo())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/totalTime()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/totalTime()/#details)
