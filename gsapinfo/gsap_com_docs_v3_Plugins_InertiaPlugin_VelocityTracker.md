...
- [Logout](https://gsap.com/community/logout/?csrfKey=8551192ff7a42fba8656091c39c6549e)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/#)
...
## Description [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/\#description "Direct link to Description")
...
VelocityTracker is in the InertiaPlugin JavaScript file and it's a membership benefit of [Club GSAP](https://gsap.com/pricing/) (so it's not in the public downloads). You can access the important methods directly through InertiaPlugin, like `InertiaPlugin.track()`.
...
## What kinds of properties can be tracked? [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/\#what-kinds-of-properties-can-be-tracked "Direct link to What kinds of properties can be tracked?")
...
[Previous\\
\\
InertiaPlugin.untrack()](https://gsap.com/docs/v3/Plugins/InertiaPlugin/static.untrack()) [Next\\
\\
.target](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.target)

## Contents

- [Description](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/#description)
- [What kinds of properties can be tracked?](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/#what-kinds-of-properties-can-be-tracked)
