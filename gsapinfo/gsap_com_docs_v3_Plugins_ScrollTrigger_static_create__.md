...
- [Logout](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/#)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create())
...
### Returns : ScrollTrigger [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/\#returns--scrolltrigger "Direct link to Returns : ScrollTrigger")

The new ScrollTrigger instance

### Details [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/\#details "Direct link to Details")
...
## Example [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/\#example "Direct link to Example")
...
[iframe](https://player.vimeo.com/video/422191943)

## Configuration [​](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/\#configuration "Direct link to Configuration")

[see the main ScrollTrigger page.](https://gsap.com/docs/v3/Plugins/ScrollTrigger/#config-object)

[Previous\\
\\
ScrollTrigger.config()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.config()) [Next\\
\\
ScrollTrigger.defaults()](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.defaults())

## Contents

- [Returns : ScrollTrigger](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/#returns--scrolltrigger)
- [Details](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/#details)
- [Example](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/#example)
- [Configuration](https://gsap.com/docs/v3/Plugins/ScrollTrigger/static.create()/#configuration)
