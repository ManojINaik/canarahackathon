...
- [Logout](https://gsap.com/community/logout/?csrfKey=9867717662b1292047663f90a872f095)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/update()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/update())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/update()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/update()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/update()/#)
...
### Returns : Draggable [​](https://gsap.com/docs/v3/Plugins/Draggable/update()/\#returns--draggable "Direct link to Returns : Draggable")

The Draggable instance itself (to make chaining possible).

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/update()/\#details "Direct link to Details")
...
[Previous\\
\\
Draggable.timeSinceDrag()](https://gsap.com/docs/v3/Plugins/Draggable/static.timeSinceDrag()) [Next\\
\\
DrawSVG](https://gsap.com/docs/v3/Plugins/DrawSVGPlugin)

## Contents

- [Returns : Draggable](https://gsap.com/docs/v3/Plugins/Draggable/update()/#returns--draggable)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/update()/#details)
