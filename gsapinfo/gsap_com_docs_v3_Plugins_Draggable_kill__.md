...
- [Logout](https://gsap.com/community/logout/?csrfKey=ccfd67c23c0be94338955131264670c6)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Draggable/kill()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Draggable/kill())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Draggable/kill()/#)

  - [CSSRule](https://gsap.com/docs/v3/Plugins/CSSRulePlugin/)

  - [Draggable](https://gsap.com/docs/v3/Plugins/Draggable/)

    - [properties](https://gsap.com/docs/v3/Plugins/Draggable/kill()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Draggable/kill()/#)
...
### Returns : Draggable [​](https://gsap.com/docs/v3/Plugins/Draggable/kill()/\#returns--draggable "Direct link to Returns : Draggable")

The Draggable instance itself (to make chaining possible).

### Details [​](https://gsap.com/docs/v3/Plugins/Draggable/kill()/\#details "Direct link to Details")
...
[Previous\\
\\
Draggable.hitTest()](https://gsap.com/docs/v3/Plugins/Draggable/static.hitTest()) [Next\\
\\
.startDrag()](https://gsap.com/docs/v3/Plugins/Draggable/startDrag())

## Contents

- [Returns : Draggable](https://gsap.com/docs/v3/Plugins/Draggable/kill()/#returns--draggable)
- [Details](https://gsap.com/docs/v3/Plugins/Draggable/kill()/#details)
