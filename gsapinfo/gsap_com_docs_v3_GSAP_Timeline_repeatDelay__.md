...
- [Logout](https://gsap.com/community/logout/?csrfKey=27e658f35873d827188001adb15efd9a)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/#)
...
### Returns : \[Number \| self\] [​](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/\#returns--number--self "Direct link to returns--number--self")

Omitting the parameter returns the current value (getter), whereas defining the parameter sets the value (setter) and returns the instance itself for easier chaining.

### Details [​](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/\#details "Direct link to Details")
...
[Previous\\
\\
.repeat()](https://gsap.com/docs/v3/GSAP/Timeline/repeat()) [Next\\
\\
.restart()](https://gsap.com/docs/v3/GSAP/Timeline/restart())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/repeatDelay()/#details)
