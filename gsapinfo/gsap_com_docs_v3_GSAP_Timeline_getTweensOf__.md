...
- [Logout](https://gsap.com/community/logout/?csrfKey=259f7e73eef10aa4e20b90161bf121db)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf())
...
- [Timeline](https://gsap.com/docs/v3/GSAP/Timeline)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf()/#)
...
[Previous\\
\\
.getChildren()](https://gsap.com/docs/v3/GSAP/Timeline/getChildren()) [Next\\
\\
.globalTime()](https://gsap.com/docs/v3/GSAP/Timeline/globalTime())

## Contents

- [Returns : Array](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf()/#returns--array)
- [Details](https://gsap.com/docs/v3/GSAP/Timeline/getTweensOf()/#details)
