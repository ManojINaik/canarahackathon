...
- [Logout](https://gsap.com/community/logout/?csrfKey=2a45e51cbd575204b6f01cb3b443cdc0)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/Observer/kill()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/Observer/kill())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/Observer/kill()/#)
  ...
  - [Observer](https://gsap.com/docs/v3/Plugins/Observer/)
    ...
    - [properties](https://gsap.com/docs/v3/Plugins/Observer/kill()/#)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/Observer/kill()/#)
...
### Details [​](https://gsap.com/docs/v3/Plugins/Observer/kill()/\#details "Direct link to Details")

Kills the Observer instance, calling `disable()` and removing it from the internal Array so that it can no longer be found via .getAll() or .getById(), making it available for garbage collection. This is permanent. If you plan on enabling the instance again later, just use `disable()` instead of `kill()`.

[Previous\\
\\
.enable()](https://gsap.com/docs/v3/Plugins/Observer/enable()) [Next\\
\\
Observer.create()](https://gsap.com/docs/v3/Plugins/Observer/static.create())

## Contents

- [Details](https://gsap.com/docs/v3/Plugins/Observer/kill()/#details)
