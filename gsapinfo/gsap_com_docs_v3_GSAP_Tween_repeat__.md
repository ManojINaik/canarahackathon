...
- [Logout](https://gsap.com/community/logout/?csrfKey=49023251bc2dc05730fb84a32b4ffcd0)
...
[Skip to main content](https://gsap.com/docs/v3/GSAP/Tween/repeat()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/GSAP/Tween/repeat())
...
- [Tween](https://gsap.com/docs/v3/GSAP/Tween)
  ...
  - [properties](https://gsap.com/docs/v3/GSAP/Tween/repeat()/#)
  ...
  - [methods](https://gsap.com/docs/v3/GSAP/Tween/repeat()/#)
...
- [more plugins](https://gsap.com/docs/v3/GSAP/Tween/repeat()/#)
...
[Previous\\
\\
.progress()](https://gsap.com/docs/v3/GSAP/Tween/progress()) [Next\\
\\
.repeatDelay()](https://gsap.com/docs/v3/GSAP/Tween/repeatDelay())

## Contents

- [Returns : \[Number \| self\]](https://gsap.com/docs/v3/GSAP/Tween/repeat()/#returns--number--self)
- [Details](https://gsap.com/docs/v3/GSAP/Tween/repeat()/#details)
