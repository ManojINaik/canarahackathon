...
- [Logout](https://gsap.com/community/logout/?csrfKey=5d22258c5925338ea5270ab401498478)
...
[Skip to main content](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/#__docusaurus_skipToContent_fallback)

[Docs](https://gsap.com/docs/v3/) [Learning](https://gsap.com/resources)

[v3.12.7](https://gsap.com/docs/v3/)

- [v3.12.7](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget())
...
- [more plugins](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/#)
  ...
  - [Inertia](https://gsap.com/docs/v3/Plugins/InertiaPlugin/)
    ...
    - [methods](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/#)
    ...
    - [VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/)
      ...
      - [properties](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/#)
...
### Returns : VelocityTracker [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/\#returns--velocitytracker "Direct link to Returns : VelocityTracker")

The VelocityTracker associated with the object (or `null` if none exists).

* * *

## Details [​](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/\#details "Direct link to Details")

Returns the VelocityTracker associated with a particular object. If none exists, `null` will be returned.

[Previous\\
\\
.get](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.get()) [Next\\
\\
.isTracking](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.isTracking())

## Contents

- [Returns : VelocityTracker](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/#returns--velocitytracker)
- [Details](https://gsap.com/docs/v3/Plugins/InertiaPlugin/VelocityTracker/.getByTarget()/#details)
